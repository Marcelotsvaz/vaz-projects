...
ipv4Change='{"Action":"CREATE","ResourceRecordSet":{"Name":"'${domainName}'","Type":"A","TTL":60,"ResourceRecords":[{"Value":"'${ipv4}'"}]}}'
ipv6Change='{"Action":"CREATE","ResourceRecordSet":{"Name":"'${domainName}'","Type":"AAAA","TTL":60,"ResourceRecords":[{"Value":"'${ipv6}'"}]}}'
