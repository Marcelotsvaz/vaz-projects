...
ipv4Change='{"Action":"DELETE","ResourceRecordSet":{"Name":"'${domainName}'","Type":"A","TTL":60,"ResourceRecords":[{"Value":"'${ipv4}'"}]}}'
ipv6Change='{"Action":"DELETE","ResourceRecordSet":{"Name":"'${domainName}'","Type":"AAAA","TTL":60,"ResourceRecords":[{"Value":"'${ipv6}'"}]}}'
