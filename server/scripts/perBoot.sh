...
ipv4Change='{"Action":"UPSERT","ResourceRecordSet":{"Name":"'${hostname}'","Type":"A","TTL":60,"ResourceRecords":[{"Value":"'${ipv4}'"}]}}'
ipv6Change='{"Action":"UPSERT","ResourceRecordSet":{"Name":"'${hostname}'","Type":"AAAA","TTL":60,"ResourceRecords":[{"Value":"'${ipv6}'"}]}}'
