...
Enable DNS hostnames: No???

Subnet (Auto):
Name: Venditore Public Subnet C
Region: sa-east-1c
IPv4 block: 10.0.0.0/24
IPv6 block: xxxx:xxxx:xxxx:xx00::/64
Auto-assign public IPv4 and IPv6

Route Table (Auto):
Name: Venditore Route Table
Set main
Delete unused one

Gateway (Auto):
Name: Venditore Gateway

ACL (Auto):
Name: Venditore ACL

Security Group (Auto):
Name: Venditore Security Group
Allow inbound SSH and HTTPS from anywhere
